...
function publishStory() {
  FB.ui({
    ...
    link: 'http://apps.facebook.com/Mobile-Login/',
    picture: 'http://apps.facebook.com/Mobile-Login/img/facebook_icon_large.png',
    actions: [{ name: 'Get Started', link: 'http://apps.facebook.com/Mobile-Login/' }],
  }, 
  function(response) {
